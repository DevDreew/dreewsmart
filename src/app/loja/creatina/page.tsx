...
export const metadata = { title: "CREATINA — DREEWSMART" };

export default function Categoria() {
  const produtos = getPorCategoria("creatina");
  return (
    <div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10">
      <p className="eyebrow mb-4">LOJA / CREATINA</p>
      <h1 className="display text-4xl font-extrabold md:text-6xl">CREATINA</h1>
      {produtos.length === 0 ? (
