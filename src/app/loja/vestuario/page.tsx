...
export const metadata = { title: "VESTUÁRIO — DREEWSMART" };

export default function Categoria() {
  const produtos = getPorCategoria("vestuario");
  return (
    <div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10">
      <p className="eyebrow mb-4">LOJA / VESTUÁRIO</p>
      <h1 className="display text-4xl font-extrabold md:text-6xl">VESTUÁRIO</h1>
      {produtos.length === 0 ? (
