...
export const metadata = { title: "ACESSÓRIOS — DREEWSMART" };

export default function Categoria() {
  const produtos = getPorCategoria("acessorios");
  return (
    <div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10">
      <p className="eyebrow mb-4">LOJA / ACESSÓRIOS</p>
      <h1 className="display text-4xl font-extrabold md:text-6xl">ACESSÓRIOS</h1>
      {produtos.length === 0 ? (
