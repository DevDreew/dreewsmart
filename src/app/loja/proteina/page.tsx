...
export const metadata = { title: "PROTEÍNA — DREEWSMART" };

export default function Categoria() {
  const produtos = getPorCategoria("proteina");
  return (
    <div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10">
      <p className="eyebrow mb-4">LOJA / PROTEÍNA</p>
      <h1 className="display text-4xl font-extrabold md:text-6xl">PROTEÍNA</h1>
      {produtos.length === 0 ? (
